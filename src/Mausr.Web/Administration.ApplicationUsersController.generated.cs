...
namespace Mausr.Web.Areas.Administration.Controllers
{
    public partial class ApplicationUsersController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ApplicationUsersController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ApplicationUsersController Actions { get { return MVC.Administration.ApplicationUsers; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Administration";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ApplicationUsers";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ApplicationUsers";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ApplicationUsersController : Mausr.Web.Areas.Administration.Controllers.ApplicationUsersController
    {
        public T4MVC_ApplicationUsersController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult Edit(Mausr.Web.Models.ApplicationUser applicationUser)
        {
            ...
            EditOverride(callInfo, applicationUser);
            return callInfo;
        }
